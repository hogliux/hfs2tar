...
int32_t internal_FastUnicodeCompare ( const uint16_t str1[], uint16_t length1,
				      const uint16_t str2[], uint16_t length2)
{
...
int32_t hfscmp( const std::basic_string<uint16_t> & str1, 
		const std::basic_string<uint16_t> & str2 ) {
  return internal_FastUnicodeCompare( str1.c_str(), str1.size(), str2.c_str(), str2.size() );
}
